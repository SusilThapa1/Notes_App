  ...
  return (
    <div className="flex flex-col min-h-screen w-full overflow-x-hidden">
      ...
      <div className="relative z-10 mt-20 px-5 md:px-10 lg:px-20 w-full">
        ...
        <section
          id="home"
          className="relative flex flex-col gap-3 justify-center items-center h-[400px] mb-10 md:h-[600px] rounded-xl shadow-lg border border-lightGreen text-center text-white bg-cover bg-center bg-no-repeat animate-bg-slide"
        >

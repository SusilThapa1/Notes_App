...
const AdminPage = () => {
  return (
    <div className="md:grid md:grid-cols-[20%,80%] gap-2  lg:grid-col-[5%,90%] mt-[60px] overflow-hidden  bg-transparent bg-no-repeat bg-center bg-cover scroll-smooth  px-5 md:pl-0 ">
      <Sidebar />
      <Routes>

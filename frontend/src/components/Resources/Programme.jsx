...
const Programme = () => {
  ...
  return (
    <div className="mt-20 py-3 px-5 flex flex-col justify-center items-center gap-5 md:px-10 lg:px-20">
      <h1 className="text-lg md:text-[2vw] text-center font-bold">
        ...
        {programmeLists.map((program, key) => (
          ...
          >
            <img
              ...
              className="object-cover cursor-pointer border border-gray-500 rounded-lg hover:scale-95 duration-500 aspect-square "
            ...
            <Link
              ...
              className="font-medium text-center lg:text-[1.1vw] p-2 shadow-lg hover:scale-95 duration-500  rounded-lg w-full bg-gray-200"
            >

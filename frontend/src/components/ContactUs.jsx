...
const ContactUs = () => {
  ...
  return (
    <div className="max-w-5xl pb-10 mt-20 mx-auto text-center">
      ...
      <form onSubmit={onSubmit} className="max-w-5xl mx-auto  ">
        ...
        <button
          type="submit"
          className="bg-transparent border  border-slate-100   px-6 py-3 rounded-full font-medium hover-supported: hover:bg-[#5CAE59] hover-supported:hover:text-gray-200 active:bg-green-600 shadow-lg transition-all duration-500"
        >
          {urlSeg === ""
            ? "Send"
            : urlSeg === "contact-us"

        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 place-items-center">
          {filteredSyllabus.map((data, index) => (
            <Link
              key={index}
              to={data.link}
              className="border border-gray-300 text-center w-full mx-auto shadow-md rounded-lg p-4 hover:bg-gradient-to-br from-cyan-200 via-gray-500 to-sky-300 hover:animate-pulse uppercase"
            >
